        ...
        <Box centerContent>
            <Box>
                <Box pb='30px'>
                    ...
                    <Text mt='20px' fontSize='1.389rem' fontWeight='500'>Sign in to your account</Text>
                    </Center>
                </Box>
                <Center>
                <Box bg='white' h='100%' rounded='md' border='1px' w={350} p={5} pt={9}>
                    <FormControl>
                        ...
                        <Button bg='black' color='white' variant='solid' w='100%' mb={10}>
                            Sign in
                        </Button>
                        <Text
